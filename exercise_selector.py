"""
exercise_selector.py — FormaFix
=================================
Interactive CLI menu for selecting a rehabilitation exercise.
"""
...
def select_exercise() -> dict:
    """Prompt the user to choose an exercise and return its info dict."""
    print("\n" + "=" * 40)
